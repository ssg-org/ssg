...
Category.create({ :name => 'Lice grada', :color => '44A8D6', :icon => 'fa-truck', :description => 'obrušene fasade, grafiti, nepropisno plakatiranje' })
Category.create({ :name => 'Zelene i rekreativne površine',  :color => 'E23408', :icon => 'fa-leaf'  })
Category.create({ :name => 'Komunalna infrastruktura', :color => '9ecc3b', :icon => 'fa-road'  })
Category.create({ :name => 'Saobraćaj i parking', :color => 'ffc80c', :icon => 'fa-trash-o'  })
Category.create({ :name => 'Zdravlje i sigurnost gradjana',  :color => '683b17', :icon => 'fa-road'  })
Category.create({ :name => 'Ostalo',  :color => '683b17', :icon => 'fa-road'  })
