...
Category.create({ :name => 'Lice grada', :color => '44A8D6', :icon => 'parkiranje.png', :description => 'obrušene fasade, grafiti, nepropisno plakatiranje' })
Category.create({ :name => 'Zelene i rekreativne površine',  :color => 'E23408', :icon => 'fasade.png'  })
Category.create({ :name => 'Komunalna infrastruktura', :color => '9ecc3b', :icon => 'okolina.png'  })
Category.create({ :name => 'Saobraćaj i parking', :color => 'ffc80c', :icon => 'rasvjeta.png'  })
